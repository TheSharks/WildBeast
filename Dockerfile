...
ENV BOT_ISBOT=true BOT_TOKEN=token BOT_EMAIL=email BOT_PASSWORD=password BOT_OAUTH=oauth \
    ...
    API_KEYS_IMGFLIP_USERNAME=username API_KEYS_IMGFLIP_PASSWORD=password API_KEYS_GOOGLE=google API_KEYS_MASHAPE=mashape API_KEYS_TWITCH_ID=twitch API_KEYS_IMGUR=imgur API_KEYS_BUGSNAG=bugsnag API_KEYS_CLEVERBOT_USER=user API_KEYS_CLEVERBOT_KEY=key
