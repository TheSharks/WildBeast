import type { SummaryMetric, MetricLabels, SummaryObservation, SummaryQuantile } from '../types.js';
...
export class Summary {
  ...
  getQuantiles(labels?: MetricLabels, quantiles: number[] = this.quantileConfig): SummaryQuantile[] {
    let filteredObs = this.observations;
