...
[configuration](/guides/configuration/) failed validation before anything
...
- A conflicting shard total proposal during a
  [migration](/scaling/resharding/): two different new totals were proposed
...
the [rolling migration](/scaling/resharding/) to complete. It starts
...
perform a real [shard total change](/scaling/resharding/).
...
[Redis](/guides/redis/) for how sessions make that work.
...
| Everything else | The [metrics reference](/observability/metrics/) and [dashboards](/observability/dashboards/) |
